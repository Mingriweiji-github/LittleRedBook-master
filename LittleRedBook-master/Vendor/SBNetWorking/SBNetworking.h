 ...
 */
typedef void (^SBResponseSuccess)(NSURLSessionDataTask * task,id responseObject);
 ...
 */
typedef void (^SBResponseFail)(NSURLSessionDataTask * task, NSError * error);


typedef void (^SBProgress)(NSProgress *progress);

@interface SBNetworking : NSObject
